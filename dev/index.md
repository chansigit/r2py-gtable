...
![A scatterplot of miles per gallon against displacement based on the
mtcars dataset. The plot is rendered by first converting the ggplot
object to a gtable and then plotting the
gtable](reference/figures/README-unnamed-chunk-2-1.png)
...
![A scatterplot of random numbers. The scatterplot is created by
combining separate grobs created with grid using
gtable.](reference/figures/README-unnamed-chunk-3-1.png)
